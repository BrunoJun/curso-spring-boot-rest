...
//				.accept(TestConfigs.CONTENT_TYPE_XML)
	...
	void testHateoas() throws JsonProcessingException {
		...
		assertTrue(content.contains("<links><rel>self</rel><href>http://localhost:8888/api/book/v1?page=0&amp;limit=6&amp;direction=asc</href></links>"));
		assertTrue(content.contains("<page><size>6</size><totalElements>3</totalElements><totalPages>1</totalPages><number>0</number></page>"));
	}
